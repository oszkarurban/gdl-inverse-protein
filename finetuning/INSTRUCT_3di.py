...
def make_prompt(tokens_3di, aa_seq="", tokenizer=None):
...
def setup_tokenizer(model_name):
    ...
    print(f"  Tokenizer check ' A C D E'  {len(test_ids)}")
    return tok
...
class InverseFoldingDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        full_prompt = make_prompt(r["tokens_3di"], r["seq"], self.tokenizer)
...
def main(args):
    ...
    json.dump({
        ...
        "prompt_format": "instruct_chat_template_spaced_residues",
...
if __name__ == "__main__":
    ...
    p.add_argument("--out_dir",    default="results/llm_3di_v2_instruct")
